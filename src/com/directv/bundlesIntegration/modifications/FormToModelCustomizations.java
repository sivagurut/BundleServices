...
import com.directv.bundlesIntegration.manager.impl.NVProcessorImpl;
...
public class FormToModelCustomizations
{
                                                          ...
                                                          HashSet<String> sensitiveIds) throws Exception
    {
        ...
        while (names.hasMoreElements())
        {
            ...
            if ((!name.equals(ModelToFormCustomizations.VISIT_ID)) && (!name.equals(NVProcessorImpl.HIDDEN_JSON_DATA)))
            {
